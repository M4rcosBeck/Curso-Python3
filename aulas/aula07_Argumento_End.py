...
# Neste exemplo, o argumento end está configurado como ' | ', o que resulta em uma saída formatada onde o separador entre as chamadas à função 'print' é uma barra vertical (|). Isso é útil para controlar a formatação da saída, evitando automaticamente a quebra de linha entre chamadas consecutivas.
